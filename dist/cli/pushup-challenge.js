...
import { boxHeader, boxDivider, boxFooter, boxLine, emptyLine, formatNumber, createProgressBar, padRight, sectionTitle } from '../lib/formatters.js';
export function displayPushupChallenge(stats) {
    console.clear();
    const lines = [];
    const width = 74;
    // Header
...
function calculateLevel(pushups) {
    const levels = [
